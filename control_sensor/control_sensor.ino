...
/* DIVERSAS MANERAS PARA ENTRAR DATOS SIN QUE DE ERRORES NI NECESIDAD DEL DELAY
int lectura_array() { 
...
void comandaM(){
  ...
  tiempo_entrado_usuario=((entrada_consola[3]-'0')*10+(entrada_consola[4]-'0'));
     ...
     if (entrada_consola[5]!='Z') {           // ERROR_protocol: la 'Z' no està en la posició correcta.
        ...
        else if (( (valor_MarchaParo == '0') && ( entrada_consola[2] == '0') ) || ( (valor_MarchaParo == '1') && (entrada_consola[2] == '1') ) || (((entrada_consola[2]-'0') < 0 ) || (entrada_consola[2]-'0') > 1 )  || (tiempo_entrado_usuario < 0) || (tiempo_entrado_usuario > 20)) 
        {
            ...
            tiempo_muestreo=((entrada_consola[3]-'0')*10+(entrada_consola[4]-'0'))*2;
